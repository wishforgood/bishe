...
class StackMultiTaskFusion_head(nn.Module):
    ...
    def forward(self, x1, x2, x3, x4, aspp=None):
        x1_size = x1.size()[2:]
        mtl4_1, mtl4_2, mtl4_3, mtl4_4 = self.mtl4(x4)  #seg_feats, edge_feats, seg_sup, edge_sup
        ...
        mtl1_3 = torch.sigmoid(mtl1_3)
        mtl1_4 = torch.sigmoid(mtl1_4)
        mtl2_3 = torch.sigmoid(mtl2_3)
        mtl2_4 = torch.sigmoid(mtl2_4)
        mtl3_3 = torch.sigmoid(mtl3_3)
        mtl3_4 = torch.sigmoid(mtl3_4)
        mtl4_3 = torch.sigmoid(mtl4_3)
        mtl4_4 = torch.sigmoid(mtl4_4)
        return out, mtl1_3, mtl1_4, mtl2_3, mtl2_4, mtl3_3, mtl3_4, mtl4_3, mtl4_4


class BANet(BaseNet):
    def __init__(self, backbone='resnet50', batchnorm=nn.BatchNorm2d, n_class=1, aspp_rates=None, edge_kernel=None, is_train=True,
                 test_size=[512, 512], aspp_out_dim=512, reduce_dim=256, pooling='max', **kwargs):
