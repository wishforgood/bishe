...
class SegmentationLoss(nn.Module):
    ...
    def forward(self, input, target):
        ...
        seg1_loss = nn.CrossEntropyLoss(seg1, target)
        seg2_loss = nn.CrossEntropyLoss(seg2, target)
        seg3_loss = nn.CrossEntropyLoss(seg3, target)
        seg4_loss = nn.CrossEntropyLoss(seg4, target)
